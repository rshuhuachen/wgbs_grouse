...
#SBATCH --mem=14000
#SBATCH --job-name=alignment2
#SBATCH --nodes=10
#SBATCH --error=/vol/cluster-data/rchen/wgbs/log/alignment_untrimmed.err
#SBATCH --output=/vol/cluster-data/rchen/wgbs/log/alignment_untrimmed.out
#SBATCH --mail-type=END
#SBATCH --mail-user=rebecca.chen@uni-bielefeld.de
# launch with: sbatch /vol/cluster-data/rchen/wgbs/workflow/align_untrimmed.sh
...
/vol/apptainer/bin/apptainer run --cleanenv \
  ...
  -1 data/E197_R1.fq.gz -2 data/E197_R2.fq.gz \
